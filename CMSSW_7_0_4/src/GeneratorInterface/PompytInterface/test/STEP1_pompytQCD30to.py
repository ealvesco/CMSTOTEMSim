...
# with command line options: Configuration/GenProduction/python/pompyt_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:GRun --conditions START42_V13::All --datatier GEN-SIM-RAW --eventcontent RAWSIM -n 2 --no_exec
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('pompyt_QCD30to_START42_V13_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
