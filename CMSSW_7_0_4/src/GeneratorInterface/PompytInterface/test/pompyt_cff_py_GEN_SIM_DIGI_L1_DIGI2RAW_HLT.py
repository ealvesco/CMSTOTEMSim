...
# with command line options: Configuration/GenProduction/python/pompyt_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:GRun --conditions START38_V12::All --datatier GEN-SIM-RAW --eventcontent RAWSIM -n 2 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/pompyt_cff.py nevts:2'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('pompyt_raw10.root'),
...
process.RandomNumberGeneratorService.generator.initialSeed = cms.untracked.uint32(134598762)
