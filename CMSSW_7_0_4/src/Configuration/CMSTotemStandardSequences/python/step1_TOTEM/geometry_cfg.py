...
TOTEMGeomXMLFiles = [
	...
	'Geometry/ForwardCommonData/data/totemt2cuts.xml',
	...
	'Geometry/TotemRPData/data/RP_Beta_19/RP_Dist_Beam_Cent.xml',
...
for CMSGeomXMLFile in CMSGeomXMLFiles:
    process.XMLIdealGeometryESSource.geomXMLFiles.remove(CMSGeomXMLFile)

for TOTEMGeomXMLFile in TOTEMGeomXMLFiles:
    process.XMLIdealGeometryESSource.geomXMLFiles.append(TOTEMGeomXMLFile)
