...
# Run first step of TOTEM simulation configuration which reads '$BASE_DIR/data/step0_CMS.root' input file and stores result in '$BASE_DIR/data/step1_TOTEM.root' output file.
cmsRun "$BASE_DIR/python/step1_TOTEM_cfg.py"

# Run second step of TOTEM simulation configuration which reads '$BASE_DIR/data/step1_CMS.root' input file and stores result in '$BASE_DIR/data/step2_TOTEM.root' output file.
cmsRun "$BASE_DIR/python/step2_TOTEM_cfg.py"
