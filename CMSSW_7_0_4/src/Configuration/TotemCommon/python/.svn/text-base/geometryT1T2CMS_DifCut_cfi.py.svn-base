...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(* ('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/CMSCommonData/data/extend/cmsextent.xml',  # DIFF: TOTEM uses normal, CMS uses extend
        ...
        'Geometry/ForwardSimData/data/TotemProdCutsOld.xml')),  # DIFF: TOTEM only 
