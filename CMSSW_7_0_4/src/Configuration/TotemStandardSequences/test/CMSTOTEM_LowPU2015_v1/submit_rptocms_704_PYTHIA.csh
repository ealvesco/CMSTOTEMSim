...
set my_dir = `pwd`
#cd ../../python
set work_dir = $my_dir/submit_gen-sim-reco-rp_2015-PYTHIA8-newformat-v1
#cmsOnly_generated  
set out_simrp_dir         = /eos/cms/store/caf/user/eliza/validation/cmstotem/RP-GEN-SIM-RECO-PYTHIA8-newformat-v3
set out_totemNtupleRP_dir = /eos/cms/store/caf/user/eliza/validation/cmstotem/RP-NTUPLE-PYTHIA8-newformat-v3
set out_totemTreeRP_dir   = /eos/cms/store/caf/user/eliza/validation/cmstotem/totemAnalysisTreeRP-PYTHIA8-newformat-v3
set copycmd  = xrdcp
mkdir -p $work_dir
...
cat > $work_dir/jobarea_${i}/Pythia8MBR_generated_cfi.py << EOF
...
process.o1 = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PYTHIA8_MB_13TeV_RPRECO_${i}.root')
)
...
xrdcp $work_dir/jobarea_${i}/PYTHIA8_MB_13TeV_RPRECO_${i}.root root://eoscms/$out_simrp_dir/
rm $work_dir/jobarea_${i}/PYTHIA8_MB_13TeV_RPRECO_${i}.root
