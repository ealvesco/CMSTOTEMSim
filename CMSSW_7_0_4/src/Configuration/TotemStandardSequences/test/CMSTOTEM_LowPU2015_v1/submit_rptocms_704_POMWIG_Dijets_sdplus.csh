...
set my_dir = `pwd`
#cd ../../python
set work_dir = $my_dir/submit_gen-sim-reco-rp_2015-POMWIGPlusDijetsSDPlus-1M-v1
#cmsOnly_generated  
...
set out_simrp_dir         = /eos/cms/store/group/phys_diffraction/CMSTotemLowPU2015/emc/MC/pomwig/SDPlus/step0/Dijets_v1/RP-GEN-SIM-RECO-PomwigDijetsPlus-newformat-v1
set out_totemNtupleRP_dir = /eos/cms/store/group/phys_diffraction/CMSTotemLowPU2015/emc/MC/pomwig/SDPlus/step0/Dijets_v1/RP-NTUPLE-PomwigDijetsPlus-newformat-v1
set out_totemTreeRP_dir   = /eos/cms/store/group/phys_diffraction/CMSTotemLowPU2015/emc/MC/pomwig/SDPlus/step0/Dijets_v1/totemAnalysisTreeRP-PomwigDijetsPlus-newformat-v1
set copycmd  = xrdcp
mkdir -p $work_dir


set step = 2000
set maxevents = 1000000
set firstevent = 0
set i = 1
