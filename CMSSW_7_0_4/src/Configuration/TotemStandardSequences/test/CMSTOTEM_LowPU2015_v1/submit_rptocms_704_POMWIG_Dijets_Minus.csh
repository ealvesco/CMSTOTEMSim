...
set my_dir = `pwd`
#cd ../../python
set work_dir = $my_dir/submit_gen-sim-reco-rp_2015-POMWIGMinusDijets-v1
#cmsOnly_generated  
set out_simrp_dir         = /eos/cms/store/caf/user/eliza/validation/cmstotem/RP-GEN-SIM-RECO-POMWIGMinusDijets-v1
set out_simcmsrecorp_dir  = /eos/cms/store/caf/user/eliza/validation/cmstotem/RP-GEN-SIM-RECO-CMS-SIM-POMWIGMinusDijets-v1
set out_totemNtupleRP_dir = /eos/cms/store/caf/user/eliza/validation/cmstotem/RP-NTUPLE-POMWIGMinus-v1
set out_totemTreeRP_dir   = /eos/cms/store/caf/user/eliza/validation/cmstotem/totemAnalysisTreeRP-POMWIGMinusDijets-v1
set copycmd  = xrdcp
mkdir -p $work_dir
...
echo "-----> step 1 CMS-SIM"
cmsDriver.py --filein file:POMWIGMinus_13TeV_RPRECO_${i}.root --fileout file:step1_POMWIG_SingleDiffractiveDijetsMinus_Pt_20_13TeV_RPRECO_CMS_SIM_${i}.root --mc --eventcontent RAWSIM --customise Configuration/StandardSequences/SimWithCastor_cff.customise, SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --datatier SIM --conditions POSTLS170_V7::All --step SIM --magField 38T_PostLS1 --geometry DBExtendedPostLS1 --python_filename step1_CMSOnly_generated_${i}.py --no_exec -n -1 

echo "----> Create cfi datacard "
cat > $work_dir/jobarea_${i}/POMWIG_SingleDiffractiveDijetsMinus_13TeV_Pt_20_cfi.py <<EOF
...
process.o1 = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:POMWIGMinus_13TeV_RPRECO_${i}.root')
)
...
process.load("POMWIG_SingleDiffractiveDijetsMinus_13TeV_Pt_20_cfi")
...
xrdcp $work_dir/jobarea_${i}/POMWIGMinus_13TeV_RPRECO_${i}.root root://eoscms/$out_simrp_dir/

rm $work_dir/jobarea_${i}/POMWIGMinus_13TeV_RPRECO_${i}.root
...
xrdcp $work_dir/jobarea_${i}/step1_POMWIG_SingleDiffractiveDijetsMinus_Pt_20_13TeV_RPRECO_CMS_SIM_${i}.root root://eoscms/$out_simcmsrecorp_dir/
rm $work_dir/jobarea_${i}/step1_POMWIG_SingleDiffractiveDijetsMinus_Pt_20_13TeV_RPRECO_CMS_SIM_${i}.root
