...
process.setName_("prodT1T2pythiaDDbeta90energy6500GeV")
...
exec 'process.' + str(process.outpath) + '.fileName = cms.untracked.string("file:prodT1T2pythiaDDbeta90energy6500GeV.root")'

# Pythia source labeled as "process.generator" @ CMSSW_3_1_1
process.load("Configuration.TotemCommon.PythiaDD_cfi")
process.generator.comEnergy = cms.double(13000)
