...
process.setName_("prodT1T2phojetMBbeta90energy6500GeV")
...
exec 'process.' + str(process.outpath) + '.fileName = cms.untracked.string("file:prodT1T2phojetMBbeta90energy6500GeV.root")'
