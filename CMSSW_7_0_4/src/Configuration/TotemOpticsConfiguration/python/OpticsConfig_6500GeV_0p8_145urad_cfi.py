...
ProtonTransportFunctionsESSource = cms.ESProducer("ProtonTransportFunctionsESSource",
    opticsFile = cms.string('Geometry/TotemRPOptics/data/parametrization_6500GeV_0p8_145urad_reco.root'),
...
BeamProtTransportSetup = cms.PSet(
    ...
    ModelRootFile = cms.string('Geometry/TotemRPOptics/data/parametrization_6500GeV_0p8_145urad_transp.root'),
