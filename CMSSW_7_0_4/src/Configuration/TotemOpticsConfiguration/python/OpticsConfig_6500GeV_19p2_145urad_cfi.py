...
BeamOpticsParamsESSource = cms.ESSource("BeamOpticsParamsESSource",
    ...
    BetaStarX = cms.double(19.2), # m
    BetaStarY = cms.double(19.2), # m
...
BeamProtTransportSetup = cms.PSet(
    ...
    ModelRootFile = cms.string('Geometry/TotemRPOptics/data/parametrization_6500GeV_19p2_145urad_transp.root'),
