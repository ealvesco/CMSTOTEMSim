...
fileNamePrefix = 'TDPythia8DP' + str(events_no)
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    comEnergy = cms.double(13000.0), #8 TeV collisions
    PythiaParameters = cms.PSet(
           pythiaMinBias = cms.vstring(
            'SoftQCD:singleDiffractive = off       ! Single diffractive',
            'SoftQCD:doubleDiffractive = off       ! Double diffractive',
            'SoftQCD:centralDiffractive = on      ! Central diffractive',
            'SoftQCD:minbias = off                 ! Nondiffractive inelastic',
