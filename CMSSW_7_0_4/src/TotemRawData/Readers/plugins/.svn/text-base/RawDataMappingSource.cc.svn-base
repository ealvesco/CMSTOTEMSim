...
boost::shared_ptr<RunAuxiliary> RawDataMappingSource::readRunAuxiliary_()
{
...
boost::shared_ptr<LuminosityBlockAuxiliary> RawDataMappingSource::readLuminosityBlockAuxiliary_()
{
