  ...
  BC_fraction(conf.getUntrackedParameter<double>("BC_fraction", 0.6))
{
  ...
  t2DataProductLabel_pads= conf.getUntrackedParameter<std::string>("t2DataProductLabel_pads", "T2PadDigi");
  t2DataProductLabel_strips= conf.getUntrackedParameter<std::string>("t2DataProductLabel_strips", "T2StripDigi");
  t2DataProductLabel_vfats= conf.getUntrackedParameter<std::string>("t2DataProductLabel_vfats", "T2Digivfat");
  ...
  // T2 data
  produces<T2StripDigiCollection>(t2DataProductLabel_strips);
  produces<T2PadDigiCollection>(t2DataProductLabel_pads);
  produces<T2DigiVfatCollection>(t2DataProductLabel_vfats);
...
void Raw2DigiProducer::produce(edm::Event& e, const edm::EventSetup& es)
{
  ...
  e.put(t2DataTheStripDigis, t2DataProductLabel_strips);
  e.put(t2DataThePadDigis, t2DataProductLabel_pads);
  e.put(t2DataTheVfats, t2DataProductLabel_vfats);
