...
class T2Event : public TObject
{
 ...
 std::vector<double> ProbChi2R_rz; 
 std::vector<double> Chi2Rreduced_rz;  
 ...
 std::vector<double> HitX;        // Phi position of all the Hits (deg)
 std::vector<double> HitY;        // R position of all the Hits (mm)
 std::vector<double> HitZ;
 std::vector<unsigned int> HitTrkID;
 std::vector<unsigned int> HitPlane;
