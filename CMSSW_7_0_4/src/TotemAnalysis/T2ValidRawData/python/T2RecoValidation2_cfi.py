...
T2ValidRaw = cms.EDAnalyzer("T2AnalyzerRaw",
	...
	# DetEffPhiWind =cms.double(10.0),
	 ...
	 PhiMaxForNoiseStudies=cms.double(359),
         ...
         t2PadDigiCollectionLabel = cms.InputTag("Raw2DigiProducer", "T2PadDigi"),
         t2StripDigiCollectionLabel = cms.InputTag("Raw2DigiProducer", "T2StripDigi"),
         t2DigiVfatCollectionLabel = cms.InputTag("Raw2DigiProducer","T2Digivfat"),
