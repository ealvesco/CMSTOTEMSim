...
#ifndef TotemAnalysis_TotemRPAnalysis_RPNtuplizer
#define TotemAnalysis_TotemRPAnalysis_RPNtuplizer

#include "TotemAnalysis/TotemRPAnalysis/interface/Ntuplizer.h"
...
class RPNtuplizer : public Ntuplizer
{
  public:
    ...
    typedef TotemRPEvent event_type;
    ...
    // ForwardTTreeAnalysis interface    
    void begin();
    void begin(const edm::Run&, const edm::EventSetup&);
    void fill(event_type&, const edm::Event&, const edm::EventSetup&);
    void end();
  ...
  private:
    ...
    /// whether we wto store information about digi or not
    bool includeDigi;
    ...
    //RPDiffMassInfo diff_mass_info_;
