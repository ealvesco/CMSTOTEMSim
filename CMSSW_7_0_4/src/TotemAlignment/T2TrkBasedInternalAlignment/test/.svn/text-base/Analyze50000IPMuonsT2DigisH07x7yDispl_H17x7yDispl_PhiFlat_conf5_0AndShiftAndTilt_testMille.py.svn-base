...
process.maxEvents = cms.untracked.PSet(
    ...
    input = cms.untracked.int32(49901) # -1 means to take all the events from the source as input
)
...
process.source = cms.Source("PoolSource",
  ...
  fileNames = cms.untracked.vstring('file:/media/usbdisk1/Simu_and_Reco/Generation50000IPMuons_T2DigisH07x7yDispl_H17x7yDispl_PhiFlatHighEta_conf5_0AndShiftAndTilt.root')                     
)
