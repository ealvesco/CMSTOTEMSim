...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(NumEvp1) # -1 means to take all the events from the source as input
)

#704_2015DataTakingCommissioningLHCF_9250_Align2015HIPV0_M2V0_ShadV6_RECO

#704_2015DataTakingCommissioningLHCF_9250_Align2015v0_RECO
 # Configure the input module (read the events from a file -- gunT1T2mu.root)
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("rfio:///castor/cern.ch/user/b/berretti/704_2015DataTakingCommissioningLHCF_9250_Align2015HIPV0_M2V0_ShadV9_RECO/run_RECOSIMUStart0run_EVB-wn10_9250.000.vmeb","rfio:///castor/cern.ch/user/b/berretti/704_2015DataTakingCommissioningLHCF_9250_Align2015HIPV0_M2V0_ShadV9_RECO/run_RECOSIMUStart0run_EVB-wn10_9250.001.vmeb","rfio:///castor/cern.ch/user/b/berretti/704_2015DataTakingCommissioningLHCF_9250_Align2015HIPV0_M2V0_ShadV9_RECO/run_RECOSIMUStart0run_EVB-wn10_9250.002.vmeb","rfio:///castor/cern.ch/user/b/berretti/704_2015DataTakingCommissioningLHCF_9250_Align2015HIPV0_M2V0_ShadV9_RECO/run_RECOSIMUStart0run_EVB-wn10_9250.003.vmeb","rfio:///castor/cern.ch/user/b/berretti/704_2015DataTakingCommissioningLHCF_9250_Align2015HIPV0_M2V0_ShadV9_RECO/run_RECOSIMUStart0run_EVB-wn10_9250.004.vmeb","rfio:///castor/cern.ch/user/b/berretti/704_2015DataTakingCommissioningLHCF_9250_Align2015HIPV0_M2V0_ShadV9_RECO/run_RECOSIMUStart0run_EVB-wn10_9250.005.vmeb","rfio:///castor/cern.ch/user/b/berretti/704_2015DataTakingCommissioningLHCF_9250_Align2015HIPV0_M2V0_ShadV9_RECO/run_RECOSIMUStart0run_EVB-wn10_9250.006.vmeb","rfio:///castor/cern.ch/user/b/berretti/704_2015DataTakingCommissioningLHCF_9250_Align2015HIPV0_M2V0_ShadV9_RECO/run_RECOSIMUStart0run_EVB-wn10_9250.007.vmeb","rfio:///castor/cern.ch/user/b/berretti/704_2015DataTakingCommissioningLHCF_9250_Align2015HIPV0_M2V0_ShadV9_RECO/run_RECOSIMUStart0run_EVB-wn10_9250.008.vmeb"), 
...
process.T2TrkBasedIntAl.MaxEvents=NumEv#NumEventWhenAlignIsCalculated
QuarterSelected=0
...
process.T2TrkBasedIntAl.DoALign=cms.bool(False)
process.T2TrkBasedIntAl.UseMillePede=cms.bool(False)
process.T2TrkBasedIntAl.DoInternalAlign=cms.bool(False)
...
process.T2TrkBasedIntAl.SelectedHalfs=cms.vuint32(QuarterSelected)       #what are the halfs to Internally  align was (0,1,2,3)
process.T2TrkBasedIntAl.HalfSelectedForPlot=cms.uint32(QuarterSelected)  #what is the half for which you want also the plot
...
process.T2TrkBasedIntAl.Effgoodhitnumber=7#8 work for h0 h1 #track in matrix numhit requirement (tracks has already passed *$*) -era 7
...
process.T2TrkBasedIntAl.AlignmentHitRMin=40.       # MAX R Value requested for Hit-0 in order to use trk for alignment. 100.0
                                                      ...
                                                      # *$* cuts already passed
process.T2TrkBasedIntAl.HitNumb4Align=cms.uint32(7) #8work hor h0 h1   # Number of required hit for each trk used for alignment *$*
                                                     # *$* cuts already passed
...
process.T2TrkBasedIntAl.UseMillePedeGlobal=cms.bool(False)
process.T2TrkBasedIntAl.IncludeQuarterTiltAlign=cms.bool(True)
process.T2TrkBasedIntAl.SelectedHalfsForTiltAlign=cms.vuint32(QuarterSelected)
process.T2TrkBasedIntAl.AXToll=cms.double(0.001) #Was 0.003
process.T2TrkBasedIntAl.AYToll=cms.double(0.001)
