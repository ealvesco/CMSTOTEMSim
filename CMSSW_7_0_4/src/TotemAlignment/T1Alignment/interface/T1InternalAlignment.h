...
#include "TotemAlignment/T1Alignment/interface/func.h"
//
// class decleration
//
...
class T1InternalAlignment : public edm::EDAnalyzer 
{
 

 public:
  explicit T1InternalAlignment(const edm::ParameterSet&);
  ~T1InternalAlignment();
...
*/
  ...
  int fitParam(int, int, T1T2TrackCollection *, double[2][5][6], double[2][5][6]); 
