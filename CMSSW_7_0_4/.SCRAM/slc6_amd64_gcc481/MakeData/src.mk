...
subdirs_src+=$(filter-out Documentation, src_IOMC src_RecoTotemRP src_TotemRPValidation src_ForwardAnalysis src_Configuration src_TotemAlignment src_Documentation src_TotemRawData src_MergingSoftware src_TotemDQMLite src_TotemCondFormats src_GeneratorInterface src_DataFormats src_TotemRawDataLibrary src_Geometry src_TotemAnalysis src_UATree src_TotemT1T2Validation src_RecoTotemT1T2 src_L1TriggerTotem src_SimG4Core src_SimG4CMS src_SimTotem)
