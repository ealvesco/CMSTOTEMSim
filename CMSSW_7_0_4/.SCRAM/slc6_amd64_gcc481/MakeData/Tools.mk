...
boost_header_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/boost/1.51.0-cms/include

ALL_TOOLS      += boost
boost_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/boost/1.51.0-cms/include
...
boost_python_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/boost/1.51.0-cms/include
...
cascade_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/cascade/2.2.04-cms/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/cgal/4.2-cms/include
cgal_EX_LIB := CGAL_Core CGAL
cgal_EX_USE := zlib boost_system

ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/charybdis/1.003-cms/include
charybdis_EX_LIB := charybdis
charybdis_EX_USE := f77compiler herwig pythia6

ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/classlib/3.1.3-cms/include
...
clhepheader_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/clhep/2.1.3.1-cms/include

ALL_TOOLS      += clhep
clhep_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/clhep/2.1.3.1-cms/include
clhep_EX_LIB := CLHEP

ALL_TOOLS      += cmsswdata
cmsswdata_EX_FLAGS_CMSSW_DATA_PACKAGE  := CalibTracker/SiPixelESProducers=V01-01-01 DetectorDescription/Schema=V02-02-01 FastSimulation/MaterialEffects=V04-02-08 FastSimulation/PileUpProducer=V04-05-18 Fireworks/Geometry=V06-13-20 GeneratorInterface/ReggeGribovPartonMCInterface=V00-00-02 Geometry/CMSCommonData=V01-09-00 Geometry/CSCGeometryBuilder=V01-08-00 Geometry/CaloEventSetup=V03-11-02 Geometry/DTGeometryBuilder=V00-05-00 Geometry/EcalCommonData=V05-05-00 Geometry/EcalSimData=V01-02-00 Geometry/EcalTestBeam=V00-09-09 Geometry/FP420CommonData=V00-06-00 Geometry/FP420SimData=V00-06-00 Geometry/ForwardCommonData=V01-05-00 Geometry/ForwardSimData=V02-02-00 Geometry/HcalCommonData=V01-05-00 Geometry/HcalSimData=V01-03-00 Geometry/HcalTestBeamData=V01-08-00 Geometry/MTCCTrackerCommonData=V01-01-00 Geometry/MuonCommonData=V01-06-00 Geometry/MuonSimData=V01-03-00 Geometry/RPCGeometryBuilder=V01-04-00 Geometry/TrackerCommonData=V01-09-05 Geometry/TrackerRecoData=V01-04-05 Geometry/TrackerSimData=V01-02-05 Geometry/TwentyFivePercentTrackerCommonData=V00-01-00 L1Trigger/RPCTrigger=V00-15-00 MagneticField/Interpolation=V00-05-00 RecoEgamma/ElectronIdentification=V00-03-35 RecoJets/JetProducers=V05-10-12 RecoMuon/MuonIdentification=V01-12-01 RecoParticleFlow/PFBlockProducer=V02-04-02 RecoParticleFlow/PFProducer=V14-08-05 RecoParticleFlow/PFTracking=V12-03-03 SimG4CMS/Calo=V02-03-07 SimG4CMS/Forward=V02-03-18 Validation/Geometry=V00-07-00

ALL_TOOLS      += coral
ALL_SCRAM_PROJECTS += coral
coral_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/cms/coral/CORAL_2_3_21-cms17/include/LCG
coral_ORDER := 98000
...
ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/dcap/2.47.5.0/include
dcap_EX_LIB := dcap
...
ALL_TOOLS      += evtgenlhc
evtgenlhc_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/evtgenlhc/9.1-cms
...
ALL_TOOLS      += fastjet
fastjet_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/fastjet/3.0.3/include
fastjet_EX_LIB := fastjetplugins fastjettools siscone siscone_spherical fastjet

ALL_TOOLS      += fftjet
fftjet_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/fftjet/1.3.1/include
...
frontier_client_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/frontier_client/2.8.8-cms2/include
...
geant4core_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/geant4/9.6.p02-cms3/include/Geant4
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/hector/1_3_4-cms5/include
hector_EX_LIB := Hector

ALL_TOOLS      += hepmc_headers
hepmc_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/hepmc/2.06.07/include
...
ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/herwig/6.521-cms/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/herwigpp/2.5.0-cms/include
...
ALL_TOOLS      += jemalloc
jemalloc_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/jemalloc/2.2.2/include
jemalloc_EX_LIB := jemalloc

ALL_TOOLS      += jimmy_headers
jimmy_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/jimmy/4.2-cms/include
...
ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/ktjet/1.06-cms/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/lhapdf/5.8.5-cms/include
...
llvm-cxxcompiler_EX_FLAGS_REM_CXXFLAGS  := -Wno-non-template-friend -Werror=format-contains-nul -Werror=maybe-uninitialized -Werror=unused-but-set-variable -Wno-unused-local-typedefs
...
ALL_TOOLS      += mcdb
mcdb_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/mcdb/1.0.2/interface
mcdb_EX_LIB := mcdb
mcdb_EX_USE := xerces-c

ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/mctester/1.25.0a-cms5/include
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/pythia8/175/include
pythia8_EX_LIB := pythia8 hepmcinterface
pythia8_EX_USE := cxxcompiler hepmc pythia6 clhep lhapdf

ALL_TOOLS      += python-ldap
python-ldap_EX_USE := openssl openldap python

ALL_TOOLS      += python
python_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/python/2.7.3-cms/include/python2.7
...
ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/rivet/1.8.2-cms/include
rivet_EX_LIB := Rivet

ALL_TOOLS      += roofitcore
roofitcore_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/lcg/roofit/5.34.09-cms5/include
...
ALL_TOOLS      += rootcint
rootcint_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/lcg/root/5.34.10-cms/cint
...
root_interface_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/lcg/root/5.34.10-cms/include
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/sherpa/1.4.2-cms/include/SHERPA-MC
...
ALL_TOOLS      += sigcpp
sigcpp_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/sigcpp/2.2.10/include/sigc++-2.0
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/tauolapp/1.1.3-cms/include
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/thepeg/1.7.0-cms/include
...
tkonlinesw_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/tkonlinesw/2.7.0-cms/include
...
ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/valgrind/3.9.0/include

ALL_TOOLS      += vdt
vdt_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/cms/vdt/v0.3.2-cms/include
vdt_EX_LIB := vdt
...
ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/xrootd/3.2.4-cms/include/xrootd
xrootd_EX_LIB := XrdUtils XrdClient

ALL_TOOLS      += xz
xz_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/xz/5.0.3__5.1.2alpha-cms/include
xz_EX_LIB := lzma

ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/yaml-cpp/0.5.1/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc481/external/yoda/1.0.4/include
yoda_EX_LIB := YODA
yoda_EX_USE := cxxcompiler boost
