...
#include "../../../../../../../../src/TotemDQMLite/GUI/interface/TabWindow.h"
...
static const char qt_meta_stringdata_TabWindow[] = {
    "TabWindow\0\0SaveLayout()\0LoadLayout()\0"
    "ClearLayout()\0Screenshot()\0"
};

void TabWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        TabWindow *_t = static_cast<TabWindow *>(_o);
        switch (_id) {
        case 0: _t->SaveLayout(); break;
        case 1: _t->LoadLayout(); break;
        case 2: _t->ClearLayout(); break;
...
const QMetaObjectExtraData TabWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TabWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TabWindow,
      qt_meta_data_TabWindow, &staticMetaObjectExtraData }
};
