...
TotemAnalysisTotemAnalysisEvent_PRE_INIT_FUNC += $$(eval $$(call LCGDict,TotemAnalysisTotemAnalysisEvent,src/TotemAnalysis/TotemAnalysisEvent/src/classes.h,src/TotemAnalysis/TotemAnalysisEvent/src/classes_def.xml,$(SCRAMSTORENAME_LIB),$(GENREFLEX_ARGS) --fail_on_warnings,Capabilities))
