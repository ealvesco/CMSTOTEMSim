...
CMSSW_BASE:=/afs/cern.ch/user/e/eliza/private/TOTEM_JPSI/RPSIM/CMSSW_7_1_21
...
HERWIG_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/herwig/6.521-ddibom3
...
JIMMY_HEADERS_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/jimmy/4.2-ddibom3
FRONTIER_CLIENT_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/frontier_client/2.8.10-ddibom
...
CASCADE_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/cascade/2.2.04-ddibom3
...
SHERPA_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/sherpa/2.1.1-ddibom4
...
FASTJET_CONTRIB_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/fastjet-contrib/1.009-cms3
GEANT4CORE_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/geant4/10.00.p02-ddibom2
G4LIB:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/geant4/10.00.p02-ddibom2/lib
...
THEPEG_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/thepeg/1.9.2p1-ddibom3
...
LHAPDF_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/lhapdf/6.1.5-ddibom3
...
export CCACHE_BASEDIR:=/afs/cern.ch/cms/slc6_amd64_gcc481/cms/cmssw/CMSSW_7_1_21
endif
ifeq ($(strip $(SCRAM_COMPILER)),llvm)
FC:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/gcc/4.8.1/bin/gfortran
endif
...
GEANT4STATIC_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/geant4/10.00.p02-ddibom2
...
GEANT4_PARFULLCMS:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/geant4-parfullcms/2014.01.27-ddibom2
...
PYTHIA8_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/pythia8/212-ddibom
...
CASCADE_HEADERS_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/cascade/2.2.04-ddibom3
...
HERWIGPP_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/herwigpp/2.7.1-ddibom3
...
TAUOLAPP_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/tauolapp/1.1.4-ddibom4
...
CORAL_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/cms/coral/CORAL_2_3_21-ddibom2
...
JIMMY_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/jimmy/4.2-ddibom3
EVTGEN_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/evtgen/1.3.0-ddibom4
...
CHARYBDIS_BASE:=/afs/cern.ch/cms/slc6_amd64_gcc481/external/charybdis/1.003-ddibom3
...
LOCALTOP:=/afs/cern.ch/user/e/eliza/private/TOTEM_JPSI/RPSIM/CMSSW_7_1_21
SCRAM_TMP:=tmp
SCRAM_INIT_LOCALTOP:=/afs/cern.ch/user/e/eliza/private/TOTEM_JPSI/RPSIM/CMSSW_7_1_21
SCRAM_BUILDFILE:=BuildFile
RELEASETOP:=/afs/cern.ch/cms/slc6_amd64_gcc481/cms/cmssw/CMSSW_7_1_21
SCRAM_INTlog:=logs
...
SCRAM_SOURCEDIR:=src
SCRAM_RTBOURNE_SET:=CMSSW:CMSSW_7_1_21:slc6_amd64_gcc481:V2_2_6_pre5:SRT_
SCRAM_CONFIGCHKSUM:=V05-04-10
SCRAM_LOOKUPDB_WRITE:=/afs/.cern.ch/cms
SCRAM_PROJECTVERSION:=CMSSW_7_1_21
