...
#     fileNames = cms.untracked.vstring('file:/afs/cern.ch/user/e/eliza/private/TOTEM_JPSI/RPSIM/CMSSW_7_0_4/src/Configuration/TotemStandardSequences/test/CMSTOTEM_LowPU2015/PYTHIA8_SD_13TeV_RPRECO_globalgeo_2k_v2.root')
fileNames = cms.untracked.vstring('root://eoscms//eos/cms/store/group/phys_diffraction/CMSTotemLowPU2015/emc/MC/pomwig/test/RP-GEN-SIM-RECO-PomwigDijetsPlus-newformat-v1/POMWIGPlus_13TeV_RPRECO_1.root')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_SDpomwigZPlus_RPRECO_CMS_SIM.root'),
