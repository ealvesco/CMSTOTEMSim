...
process.source = cms.Source("PoolSource",
    secondaryFileNames = cms.untracked.vstring(),
     fileNames = cms.untracked.vstring('/store/group/phys_diffraction/CMSTotemLowPU2015/emc/MC/pomwig/sdminus/step0/Dijets_v1/RP-GEN-SIM-RECO-PomwigDijetsMinus-newformat-v1//POMWIGPlus_13TeV_RPRECO_184.root') 
...
#     fileNames = cms.untracked.vstring('file:/afs/cern.ch/user/e/eliza/private/TOTEM_JPSI/RPSIM/CMSSW_7_0_4/src/Configuration/TotemStandardSequences/test/CMSTOTEM_LowPU2015/PYTHIA8_MB_13TeV_RPRECO_globalgeo_2k_v2.root')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_PYTHIA8DijetsPt20_RPRECO_CMS_SIM_newformat_v1.root'),
