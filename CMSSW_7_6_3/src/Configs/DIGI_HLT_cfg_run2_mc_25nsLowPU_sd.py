...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
      'file:/afs/cern.ch/user/e/eliza/private/TOTEM_JPSI/RPSIM/CMSSW_7_1_21/src/step1_SDPYTHIA8_RPRECO_CMS_SIM_13122016.root'), 
   #  'file:/afs/cern.ch/user/e/eliza/private/TOTEM_JPSI/RPSIM/CMSSW_7_1_21/src/Configs/step1_SDPlusPomwig_RPRECO_CMS_SIM_oficialChain.root'),#oficial chain
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step1_DIGI_L1_DIGI2RAW_HLT_PYTHIA8_testoficialchain.root'),
