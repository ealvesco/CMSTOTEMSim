...
#pragma link C++ class vector<MyDiJet>+;
#pragma link C++ class MyEvtId+;
#pragma link C++ class vector<MyEvtId>+;
...
#pragma link C++ class vector<MyL1Trig>+;
#pragma link C++ class MyL1TrigOld+;
#pragma link C++ class vector<MyL1TrigOld>+;
#pragma link C++ class MyMITEvtSel+;
#pragma link C++ class vector<MyMITEvtSel>+;
#pragma link C++ class MyPart+;
#pragma link C++ class vector<MyPart>+;
#pragma link C++ class MySimVertex+;
#pragma link C++ class vector<MySimVertex>+;
...
#pragma link C++ class MyKshorts+; 
#pragma link C++ class vector<MyKshorts>+; 
#pragma link C++ class MyLambdas+;  
#pragma link C++ class vector<MyLambdas>+;  
