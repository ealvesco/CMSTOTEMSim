...
void template_UATreeReader(vector<string> const& fileNames, string const& outputFileName, const Int_t nevt_max);

void template_UATreeReader(string const& fileListName="filenames.txt", string const& outputFileName = "output.root", const Int_t nevt_max = 100){
   ...
   template_UATreeReader(fileNames,outputFileName,nevt_max);
}

void template_UATreeReader(vector<string> const& fileNames, string const& outputFileName = "output.root", const Int_t nevt_max = 100){
  ...
  selectHLTPathNames.push_back("HLT_L1TOTEM0_RomanPotsAND_PixelClusters5_part0_v1");
  selectHLTPathNames.push_back("HLT_L1TOTEM0_RomanPotsAND_PixelClusters5_part1_v1");
  selectHLTPathNames.push_back("HLT_L1TOTEM0_RomanPotsAND_PixelClusters5_part2_v1");
  selectHLTPathNames.push_back("HLT_L1TOTEM0_RomanPotsAND_PixelClusters5_part3_v1");
  selectHLTPathNames.push_back("HLT_L1TOTEM0_RomanPotsAND_PixelClusters5_part4_v1");
  selectHLTPathNames.push_back("HLT_L1TOTEM0_RomanPotsAND_PixelClusters5_part5_v1");
  selectHLTPathNames.push_back("HLT_L1TOTEM0_RomanPotsAND_PixelClusters5_part6_v1");
  selectHLTPathNames.push_back("HLT_L1TOTEM0_RomanPotsAND_PixelClusters5_part7_v1");
  ...
  hltPathNames.push_back("HLT_L1Muon_NotMinimumBiasHF2AND_v1");
  ...
  //vector<MyZDCHit>*  zdcHits_coll  = NULL;
  //vector<MyZDCDigi>* zdcDigis_coll = NULL;
  ...
  for(vector<TString>::iterator itfiles = vfiles->begin() ; itfiles != vfiles->end() && i_tot < nevt_max_corr ; ++itfiles){
    ...
    if(isMC){
       ...
       tree->SetBranchAddress("cmsak4PFJetsUA",&pfJet_coll);
    ...
    for(int i_evt = 0; i_evt < nev && i_tot < nevt_max_corr; ++i_evt , ++i_tot){
	 ...
	 double xi_plus_gen = genEPlusPz/CMEnergy_;
	 double xi_minus_gen = genEMinusPz/CMEnergy_;
	 ...
	 if(proton_pz_plus > 0.){
	    ...
	    double out_x, out_thx, out_y, out_thy, out_xi;
            /*if(useRPParam) proton_plus_rp_accept_020 = protonRPDetected(0., thx_proton_plus, 0., thy_proton_plus, -xi_proton_plus, 20, out_x, out_thx, out_y, out_thy, out_xi);
	    ...
	    if(useRPParam) proton_plus_rp_accept_021 = protonRPDetected(0., thx_proton_plus, 0., thy_proton_plus, -xi_proton_plus, 21);
	    ...
	    if(useRPParam) proton_plus_rp_accept_024 = protonRPDetected(0., thx_proton_plus, 0., thy_proton_plus, -xi_proton_plus, 24);
	    if(useRPParam) proton_plus_rp_accept_025 = protonRPDetected(0., thx_proton_plus, 0., thy_proton_plus, -xi_proton_plus, 25);
	    if(useRPParam) proton_plus_rp_accept_120 = protonRPDetected(0., thx_proton_plus, 0., thy_proton_plus, -xi_proton_plus, 120);*/
	 }
	 ...
	 if(proton_pz_minus < 0.){ 
	    ...
	    double out_x, out_thx, out_y, out_thy, out_xi;
	    /*if(useRPParam) proton_minus_rp_accept_120 = protonRPDetected(0., thx_proton_minus, 0., thy_proton_minus, -xi_proton_minus, 120, out_x, out_thx, out_y, out_thy, out_xi);
	    ...
	    if(useRPParam) proton_minus_rp_accept_121 = protonRPDetected(0., thx_proton_minus, 0., thy_proton_minus, -xi_proton_minus, 121);
	    if(useRPParam) proton_minus_rp_accept_124 = protonRPDetected(0., thx_proton_minus, 0., thy_proton_minus, -xi_proton_minus, 124);
	    if(useRPParam) proton_minus_rp_accept_125 = protonRPDetected(0., thx_proton_minus, 0., thy_proton_minus, -xi_proton_minus, 125);
	    if(useRPParam) proton_minus_rp_accept_020 = protonRPDetected(0., thx_proton_minus, 0., thy_proton_minus, -xi_proton_minus, 20);*/
	 }
	 ...
	 bool proton_plus_rp_accept = ( proton_plus_rp_accept_020 && proton_plus_rp_accept_024 ) ||
	    ( proton_plus_rp_accept_021 && proton_plus_rp_accept_025 );
	 bool proton_minus_rp_accept = ( proton_minus_rp_accept_120 && proton_minus_rp_accept_124 ) ||
