...
#process.hltRomanPotsTTBB = process.hltFilter.clone(HLTPaths = ['HLT_L1TOTEM3_RomanPotsTTBB_part*'])
#process.p.replace(process.uabasetree, process.hltRomanPotsTTBB+process.uabasetree) 
